                ...
                <div class="card-body">
                    <form action="javascript:;" id="formEditBarang" method="post" class="p-1">
                        ...
                        <div class="input-group input-group-outline mb-3">
                            ...
                            <input type="text" name="kode_barang" id="kodeBarang" class="form-control" value="{{ $data->kode_barang }}">
                        </div>
                        <div class="input-group input-group-outline mb-3">
                            <label class="form-label">Nama Barang</label>
                            <input type="text" name="nama_barang" id="namaBarang" class="form-control" value="{{ $data->nama_barang }}">
                        </div>
                        <div class="input-group input-group-outline mb-3">
                            <label class="form-label">Harga Barang</label>
                            <input type="number" name="harga" id="hargaBarang" class="form-control" value="{{ $data->harga }}">
                        </div>
                        <div class="input-group input-group-outline mb-3">
                            <label class="form-label">Didaftarkan Oleh</label>
                            <input type="text" name="didaftarkan_oleh" id="didaftarkanOleh" class="form-control" value="{{ $data->didaftarkan_oleh }}">
                        </div>
