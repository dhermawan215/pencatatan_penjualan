                        ...
                        <table id="adminUsers" class="table table-hover table-striped align-items-center mb-0">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control tfoot-seacrh border" placeholder="nomer user" id="tfootName" data-index="<?php echo $data_index;
                                                                                                                                                        $data_index++; ?>">
                                    </td>
                                    <td><input type="text" class="form-control tfoot-seacrh border" placeholder="emai user" id="tfootEmail" data-index="<?php echo $data_index;
                                                                                                                                                        $data_index++; ?>">
                                    </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Formulir Tambah User</h5>
